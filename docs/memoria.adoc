...
=== Diseño de BD
Link hacia el digrama relacional de la base de dades:  https://drive.google.com/file/d/1HUVLYU9hPKxmyfT6V3yxM_MYT2UfzMvv/view?usp=sharing[Diagrama]
...
image::PrevisualizarCotenido.jpg[Sketch de previsualizacion tipo contenido, width=40%]
...
Si se realiza satisfactioriamente este proyecto el alumno contara con conocimientos sobre: 
...
- Se ideara para poner eventos en java de manera sincrona

- Resolución de errores

- Podrá adaptar un codigo antiguo a nuevos requisitos
