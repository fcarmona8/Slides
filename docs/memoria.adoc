...
Semana 2
Se completo la pantalla editar, cambiamos el diseño del reordenamiento, agregamos la funcion de elimnar y modificar las diapositivas. Empezamos a realizar los mockup de 
