                ...
                <form method='post'>
                    <button class="tituloGuardado" name="editarPres" type='submit' ><?php echo $titol; ?></button>
                        <div class='buttons-editar'>
                            <!-- Enlace para editar estilos en una nueva página -->
                            <button>
    ...
    <div class="down">
        ...
        <div class="right">
            <form method="POST" id="formDiapoCont">
                ...
                <input type="text" name="titol" class="titolContDiapo" placeholder="Titulo" maxlength="25"required<?php if ($editDiapo === TRUE) {
                   ?> value="<?= $titolDiapo; ?>" <?php ;
                   } ?> >
                <textarea name="contingut" class="contingutDiapo" placeholder="Contenido" required ><?php if ($editDiapo === TRUE) {
                   echo $contingut;
                   } ?></textarea>
